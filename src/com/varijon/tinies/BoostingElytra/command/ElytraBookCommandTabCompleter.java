...
public class ElytraBookCommandTabCompleter implements TabCompleter
{
	ArrayList<String> lstBlocks;
	ArrayList<String> lstParticles;
	
	public ElytraBookCommandTabCompleter() 
	{
	...
	public List<String> onTabComplete(CommandSender sender, Command command, String label, String[] args) 
	{
		...
		if(args.length > 1)
		{
			...
			lstTabComplete1.add("returnsoldbook");
			...
			if(args[args.length-1].contains("returnsoldbook"))
			{
				lstTabComplete2.add("returnsoldbook:0");
				lstTabComplete2.add("returnsoldbook:1");
